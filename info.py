...
API_ID = int(environ.get('API_ID', '32541562')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'e37e4432298d5a5eb4a6e32c18804283')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8968204021:AAHSu4tHbuTkHNK157XWd_Vf6KwhDWxqtiU")    # Bot token from @BotFather
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003582815360').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://MaxPayne:MaxPayneontop@cluster0.gn7wsit.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
